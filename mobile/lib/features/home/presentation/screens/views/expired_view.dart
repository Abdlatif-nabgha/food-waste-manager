    ...
    return Consumer<ProductProvider>(
      builder: (context, provider, child) {
        return Scaffold(
          ...
          body: provider.isLoading && provider.expiredProducts.isEmpty
              ? const Center(child: CircularProgressIndicator())
              : RefreshIndicator(
                  onRefresh: () => provider.fetchAllData(),
                  child: provider.expiredProducts.isEmpty
                      ? ListView(
                          children: [
                      ...
                      : ListView.builder(
                          ...
                          itemCount: provider.expiredProducts.length,
                          itemBuilder: (context, index) {
                            final product = provider.expiredProducts[index];
                            return ProductCard(
                              product: product,
